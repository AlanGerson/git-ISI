	...
	<div class="row">	
		...
		<div class="col-sm" v-for="pokemon in pokemons">
			<div class="card text-center"  style="width: 18rem; margin-top: 50px">
				<img  style="height: 150px; width: 150px; background-color: #EFEFEF; margin: 50px" class="card-img-top rounded-circle mx-auto d-block" v-bind:src="pokemon.picture" alt="">
				  <div class="card-body">
